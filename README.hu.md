...
<img src="https://hievents-public.s3.us-west-1.amazonaws.com/website/github-banner.png?v=1" alt="BrothersBit - Nyílt forráskódú eseménykezelő és jegyértékesítő platform" width="100%">
...
[Próbálja ki a felhőt →](https://app.brothersbit.com/auth/register?utm_source=gh-readme) · [Élő demó](https://app.brothersbit.com/event/2/hievents-conference-2030?utm_source=gh-readme) · [Dokumentáció](https://brothersbit.com/docs?utm_source=gh-readme) · [Weboldal](https://brothersbit.com?utm_source=gh-readme)
...
A legtöbb jegyértékesítő platform jegyenkénti díjakat számít fel, és az adatait a saját ökoszisztémájába zárja. **A BrothersBit egy modern,
...
<img alt="BrothersBit irányítópult" src="https://hievents-public.s3.us-west-1.amazonaws.com/website/github-screenshot.png"/>
...
| Funkció                                   | BrothersBit | Eventbrite | Tickettailor | Dice     |
|:------------------------------------------|:----------|:-----------|:-------------|:---------|
...
📖 [Teljes telepítési útmutató](https://brothersbit.com/docs/getting-started?utm_source=gh-readme)

<br>

## BrothersBit Cloud

Inkább nem szeretne saját szervert üzemeltetni? A **[BrothersBit Cloud](https://app.brothersbit.com/auth/register?utm_source=gh-readme)** egy teljesen
felügyelt megoldás nulla beállítással, automatikus frissítésekkel és felügyelt infrastruktúrával.

[Kezdje el →](https://app.brothersbit.com/auth/register?utm_source=gh-readme)
...
| Forrás          | Link                                                                                          |
|:----------------|:----------------------------------------------------------------------------------------------|
| Első lépések    | [brothersbit.com/docs/getting-started](https://brothersbit.com/docs/getting-started?utm_source=gh-readme) |
| Konfiguráció    | [brothersbit.com/docs/configuration](https://brothersbit.com/docs/configuration?utm_source=gh-readme)     |
| API referencia  | [brothersbit.com/docs/api](https://brothersbit.com/docs/api?utm_source=gh-readme)                         |
| Webhookok       | [brothersbit.com/docs/webhooks](https://brothersbit.com/docs/webhooks?utm_source=gh-readme)               |
...
📖 [Dokumentáció](https://brothersbit.com/docs?utm_source=gh-readme) · 📧 [contact@brothersbit.com](mailto:contact@brothersbit.com) ·
...
[kiadások oldalon](https://github.com/dsddet/Hi.Events/releases).

<br>

## Licenc

A BrothersBit **AGPL-3.0 licenc alatt áll további feltételekkel**. Kereskedelmi licenc
elérhető. [Tudjon meg többet](https://brothersbit.com/licensing).

<br>

<div align="center">

**[Weboldal](https://brothersbit.com)** · **[Dokumentáció](https://brothersbit.com/docs)** · *
